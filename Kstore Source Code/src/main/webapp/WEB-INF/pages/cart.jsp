...
<body>
			...
			<div class="hero-content pb-5 text-center">
				...
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						<p class="lead text-muted">当前购物车内共有${cartbarcount}件物品</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section>
		<div class="container">
			<span id="checkpwdmessage text-danger">${requestScope.cartmessage }</span>
			<div class="row mb-5">
				<div class="col-lg-8">
					<div class="cart">
						<div class="cart-wrapper">
							<div class="cart-header text-center">
								<div class="row">
									<div class="col-5">物品</div>
									<div class="col-2">价格</div>
									<div class="col-2">件数</div>
									<div class="col-2">仍有库存</div>
									<div class="col-1"></div>
								</div>
							</div>
							<div class="cart-body">
									...
									<c:forEach items="${cartbargoods}" var="cartbargoods">
										...
										<div class="cart-item">
											<div class="row d-flex align-items-center text-center">
												<div class="col-5">
													<!--     原来的示例图片                    <div class="d-flex align-items-center"><img src="img/product/product-square-ian-dooley-347968-unsplash.jpg" alt="..." class="cart-item-img"> -->
													<div class="d-flex align-items-center">
														<img src="${cartbargoods.pictures}" alt="..."
															class="cart-item-img">
														<div class="cart-title text-left">
															<a href="detail.html" class="text-uppercase text-dark"><strong>${cartbargoods.name}</strong></a><br>
															<span class="text-muted text-sm">类别:
																${cartbargoods.type}</span><br> <span
																class="text-muted text-sm">上架时间:
																${cartbargoods.release_time}</span>
														</div>
													</div>
												</div>
												<div class="col-2">${cartbargoods.price}RMB</div>
												<div class="col-2">
													<div class="d-flex align-items-center">
												...
												<c:if test="${cartbargoods.state==false }">
													<div class="col-2 py-4 align-middle"><span
														class="badge text-center badge-info p-2">有库存</span></div>
												</c:if>
												<c:if test="${cartbargoods.state==true }">
													<div class="col-2 py-4 align-middle"><span
														class="badge text-center badge-danger p-2">没有库存</span></div>
												</c:if>
												
												<div class="col-1 text-center">
													<a
														href="deleteCart?delete_good_id=${cartbargoods.goods_id}"
														class="cart-remove"> <i class="delete fa fa-times"></i></a>
												</div>
											</div>
										</div>
									</c:forEach>
					...
					<div
						...
						<a href="category-no-sidebar" class="btn btn-link text-muted"><i
							class="fa fa-chevron-left"></i> 继续购物</a><a
							href="checkout1" class="btn btn-dark">下单<i
					...
					<div class="block mb-5">
						...
						<div class="block-body bg-light pt-1">
							...
							<ul class="order-summary mb-0 list-unstyled">
								...
								<li class="order-summary-item"><span>税收</span><span>0.00
										RMB</span></li>
