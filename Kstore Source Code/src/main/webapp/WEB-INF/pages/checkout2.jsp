				...
				<div class="col-lg-8">
					<ul class="custom-nav nav nav-pills mb-5">
						...
						<li class="nav-item w-25"><a href="checkout2"
							class="nav-link text-sm active">运送方式</a></li>
						...
						<div class="block-body">
							<div class="row">
								<div class="form-group col-md-6 d-flex align-items-center">
									<input type="radio" name="shippping" id="option0"> <label
										for="option0" class="ml-3"><strong
										class="d-block text-uppercase mb-2">顺丰</strong><span
										class="text-muted text-sm">隔天到</span></label>
								</div>
								<div class="form-group col-md-6 d-flex align-items-center">
									<input type="radio" name="shippping" id="option1"> <label
										for="option1" class="ml-3"><strong
										class="d-block text-uppercase mb-2">京东</strong><span
										class="text-muted text-sm">隔天到</span></label>
								</div>
								<div class="form-group col-md-6 d-flex align-items-center">
									<input type="radio" name="shippping" id="option2"> <label
										for="option2" class="ml-3"><strong
										class="d-block text-uppercase mb-2">EMS</strong><span
										class="text-muted text-sm">随缘到</span></label>
								</div>
								<div class="form-group col-md-6 d-flex align-items-center">
									<input type="radio" name="shippping" id="option3"> <label
										for="option3" class="ml-3"><strong
										class="d-block text-uppercase mb-2">圆通</strong><span
										class="text-muted text-sm">三天到</span></label>
								</div>
							</div>
						</div>
						<div
							class="mb-5 d-flex justify-content-between flex-column flex-lg-row">
							<a href="cart.html" class="btn btn-link text-muted"> <i
								class="fa fa-angle-left mr-2"></i>返回
							</a><a href="checkout3" class="btn btn-dark">选择支付方式<i class="fa fa-angle-right ml-2"></i>
							</a>
						</div>
					</div>
				</div>
						...
						<div class="block-body bg-light pt-1">
							...
							<ul class="order-summary mb-0 list-unstyled">
								...
								<li class="order-summary-item"><span>交税</span><span>0.00
										RMB</span></li>
								<li class="order-summary-item border-0"><span>总共</span><strong
