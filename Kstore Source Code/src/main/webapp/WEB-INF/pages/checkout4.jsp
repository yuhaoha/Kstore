				...
				<div class="col-lg-8">
					<ul class="custom-nav nav nav-pills mb-5">
						...
						<li class="nav-item w-25"><a href="checkout3"
							class="nav-link text-sm ">支付方式 </a></li>
						<li class="nav-item w-25"><a href="checkout4"
							class="nav-link text-sm active">订单一览</a></li>
					</ul>
					<div class="mb-5">
						<div class="cart">
							<div class="cart-wrapper">
								<div class="cart-header text-center">
									<div class="row">
										<div class="col-6">物品</div>
										<div class="col-2">价格</div>
										<div class="col-2">数量</div>
										<div class="col-2">总计</div>
									</div>
								</div>
								<div class="cart-body">
									<!-- Product-->
										...
										<c:forEach items="${cartbargoods}" var="cartbargoods">
											<div class="cart-item">
												<div class="row d-flex align-items-center text-center">
														...
														<div class="d-flex align-items-center">
															...
															<div class="cart-title text-left">
																...
																<span class="text-muted text-sm">类别:
																	${cartbargoods.type}</span><br>
																<span class="text-muted text-sm">上架时间:
													...
													<div class="col-2 text-center">${cartbargoods.price}RMB</div>
												</div>
											</div>
										</c:forEach>
									</c:if>
					...
					<div
						...
						<a href="checkout3.html" class="btn btn-link text-muted"> <i
							class="fa fa-angle-left mr-2"></i>返回
						</a><a href="checkout5.html" class="btn btn-dark">下单<i
					...
					<div class="block mb-5">
						...
						<div class="block-body bg-light pt-1">
							...
							<ul class="order-summary mb-0 list-unstyled">
								...
								<li class="order-summary-item"><span>收税</span><span>0.00
										RMB</span></li>
