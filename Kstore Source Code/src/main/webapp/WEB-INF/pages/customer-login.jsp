	...
	<section class="hero">
		<div class="container">
			...
			<div class="hero-content pb-5 text-center">
				<h1 class="hero-heading mb-0">用户登陆</h1>
			</div>
		</div>
	</section>
	<!-- customer login-->
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-5">
					<div class="block">
						<div class="block-header">
							<h6 class="text-uppercase mb-0">登陆</h6>
						</div>
						<div class="block-body">
							<p class="lead">已有账户？</p>
							<hr>
							<span style="color: red"><%=request.getAttribute("loginmessage") == null ? "" : request.getAttribute("loginmessage")%></span>
							<form action="login" method="post">
								<div class="form-group">
									<label for="loginname" class="form-label">用户名</label> <input
										name="loginname" id="email" type="text" required
										oninvalid="this.setCustomValidity('用户名不能为空')"
										oninput="this.setCustomValidity('')" class="form-control">
								</div>
								<div class="form-group">
									<label for="loginpassword" class="form-label">密码</label> <input
										name="loginpassword" id="password" required
								...
								<div class="form-group text-center">
									<button type="submit" class="btn btn-outline-dark">
										<i class="fa fa-sign-in-alt mr-2"></i>登入
									</button>
								</div>
							</form>
						</div>
				...
				<div class="col-lg-5">
					<div class="block">
						<div class="block-header">
							<h6 class="text-uppercase mb-0">注册新用户</h6>
						</div>
						<div class="block-body">
							<p class="lead">还不是我们的用户？</p>
							<hr>
							<span id="checkmessage" style="color: red"><%=request.getAttribute("checkmessage") == null ? "" : request.getAttribute("checkmessage")%></span>
							<form action="register" method="post">
								<div class="form-group">
									<label for="registername" class="form-label">用户名</label> <input
										id="registername" required
										oninvalid="this.setCustomValidity('用户名不能为空')"
										oninput="this.setCustomValidity('')" name="registername"
										type="text" class="form-control" onblur="checkUser()">
								</div>
								<div class="form-group">
									<label for="email" class="form-label">邮箱</label> <input
										id="email" required
										oninvalid="this.setCustomValidity('邮箱不能为空')"
										oninput="this.setCustomValidity('')" name="registeremail"
								...
								<div class="form-group">
									<label for="password" class="form-label">密码</label> <input
										...
										oninvalid="this.setCustomValidity('密码不能为空')"
										oninput="this.setCustomValidity('')" name="registerpassword"
