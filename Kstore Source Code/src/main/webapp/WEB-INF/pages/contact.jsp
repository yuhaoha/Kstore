	...
	<section class="hero">
		<div class="container">
			...
			<div class="hero-content pb-5 text-center">
				<h1 class="hero-heading">联系我们</h1>
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						<p class="lead text-muted">您对我们的服务有什么好的提议吗？想对我们的开发者说些什么吗？欢迎联系我们。</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 text-center text-md-left">
					<svg
						class="svg-icon svg-icon-light text-primary w-3rem h-3rem mb-3">
              <use xlink:href="#navigation-map-1"> </use>
            </svg>
					<h4 class="ff-base">地址</h4>
					<p class="text-muted">
						天津市<br>南开大学<br>软件学院<strong>Keyboard Man</strong>
					</p>
				</div>
				<div class="col-md-4 text-center text-md-left">
					<svg
              ...
              <use xlink:href="#audio-call-1"> </use>
					...
					<h4 class="ff-base">联系中心</h4>
					<p class="text-muted">我们的客服人员可以随时联系.</p>
					<p class="text-muted">
              ...
              <use xlink:href="#mail-1"> </use>
					...
					<h4 class="ff-base">邮件支持</h4>
					<p class="text-muted">如有问题，可以随时和我们联系。</p>
