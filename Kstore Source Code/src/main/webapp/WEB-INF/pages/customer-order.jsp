		...
		<div class="search-area-wrapper">
			<div
              ...
              <use xlink:href="#close-1"> </use>
				...
				<form autocomplete="off" action="searchgoods"
			...
			<div class="hero-content pb-5 text-center">
				...
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						<p class="lead text-muted">您的订单已准备完毕</p>
						<p class="text-muted">
							如果有任何问题 ，<a href="contact">请联系我们</a>, 我们的客服24小时在线.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-8 col-xl-9">
							...
							<div class="cart-body">
								...
								<div class="cart-item">
									<div class="row d-flex align-items-center text-center">
										<div class="col-6">
											<div class="d-flex align-items-center">
												<img src="${viewpicture}" alt="..." class="cart-item-img">
												<div class="cart-title text-left">
													<a href="detail?detailnum=${goods.goods_id }"
														class="text-uppercase text-dark"><strong>${requestScope.viewgoodsname}</strong></a><br>
													<span class="text-muted text-sm">${vieworder.buy_time}</span><br>
													<span class="text-muted text-sm">${vieworder.state}</span>
												</div>
											</div>
										</div>
										<div class="col-2">${vieworder.goods_price}¥</div>
					...
					<div class="row my-5">
							...
							<div class="block mb-5">
								...
								<div class="block-body bg-light pt-1">
									...
									<ul class="order-summary mb-0 list-unstyled">
										<li class="order-summary-item"><span>订单总计</span><span>${vieworder.goods_price}
												¥</span></li>
										<li class="order-summary-item"><span>运费</span><span>0
												¥</span></li>
										<li class="order-summary-item"><span>交税</span><span>$0.00</span></li>
										<li class="order-summary-item border-0"><span>总计</span><strong
											class="order-summary-total">${vieworder.goods_price}
												¥</strong></li>
									</ul>
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="block-body bg-light pt-1">
								<p><%=request.getAttribute("profilename") == null ? "" : request.getAttribute("profilename")%><br>
									<%=request.getAttribute("profileprovince") == null
					? "还没有地址信息"
					: request.getAttribute("profileprovince")%><br>
									<%=request.getAttribute("profilecity") == null ? "" : request.getAttribute("profilecity")%><br>
									<%=request.getAttribute("profiledistrict") == null ? "" : request.getAttribute("profiledistrict")%><br>
									<%=request.getAttribute("profilestreet") == null ? "" : request.getAttribute("profilestreet")%><br>
								</p>
							</div>
						</div>
					</div>
				...
				<div class="col-xl-3 col-lg-4 mb-5">
					<div class="customer-sidebar card border-0">
						<div class="customer-profile">
							<a href="#" class="d-inline-block"><img height="160"
								width="160" onerror="this.src='img/photo/blog-avatar.jpg'"
								src="<%=request.getAttribute("url") == null ? "" : request.getAttribute("url")%>"
								class="rounded-circle customer-image"></a>
						...
						<div class="row">
							...
							<div class="col-lg-6 align-items-center">
								<br> <br> <label for="product-title"
									...
									oninvalid="this.setCustomValidity('标题不能为空！')"
								...
								<textarea class="form-control" name="goodsdescription"
									id="product-detail" rows="4" required
									oninvalid="this.setCustomValidity('商品详情不能为空！')"
								...
								<div class="input-group mb-2 mr-sm-2">
									...
									<input type="number" name="goodsprice" class="form-control"
										...
										oninvalid="this.setCustomValidity('商品价格不能为空！')"
										oninput="this.setCustomValidity('')">
								</div>
								<hr>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
						...
						<ul class="list-unstyled">
							...
							<li><a href="register" class="text-muted">Register </a></li>
							<li><a href="#" class="text-muted">Wishlist </a></li>
							<li><a href="category-no-sidebar" class="text-muted">Our
									Products </a></li>
