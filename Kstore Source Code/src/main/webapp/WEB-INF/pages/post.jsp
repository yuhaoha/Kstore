...
<body>
	...
	<section class="hero">
		<div class="container">
			...
			<div class="hero-content pb-5 text-center">
				<h1 class="hero-heading">Your posts</h1>
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						<p class="lead">Your posts in one place.</p>
					</div>
				</div>
				<div class="row">
					<div id="post-success"
						class="alert alert-warning mx-auto text-center w-75 alert-dismissible fade show"
						role="alert" style="display: none">
						<strong>亲！</strong> 发布成功！
	...
	<section>
							...
							<div class="row">
								...
								<div class="col-lg-6 align-items-center">
									...
									<textarea class="form-control" name="goodsdescription"
										id="product-detail" rows="4"></textarea>
									<hr>
		...
		<div class="container">
			<span id="checkpwdmessage" style="color: red"><%=request.getAttribute("postmessage") == null ? "" : request.getAttribute("postmessage")%></span>
			<div class="row">
				<div class="col-lg-8 col-xl-9">
					<table
						...
						<thead class="bg-light">
							<tr>
								<th class="py-4 text-uppercase text-sm">商品名称</th>
								<th class="py-4 text-uppercase text-sm">发布时间</th>
								<th class="py-4 text-uppercase text-sm">价格</th>
								<th class="py-4 text-uppercase text-sm">状态</th>
								<th class="py-4 text-uppercase text-sm">详情</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${goodsList}" var="goods">
								<tr>
									<th class="py-4 align-middle">${goods.name}</th>
									<td class="py-4 align-middle">${goods.release_time }</td>
									<td class="py-4 align-middle">${goods.price }</td>
									<c:if test="${goods.state==false}">
										<td class="py-4 align-middle"><span
											class="badge text-uppercase badge-info p-2">在售</span></td>
									</c:if>
									<c:if test="${goods.state==true}">
										<td class="py-4 align-middle"><span
											class="badge text-uppercase badge-success p-2">已售出</span></td>
									</c:if>
