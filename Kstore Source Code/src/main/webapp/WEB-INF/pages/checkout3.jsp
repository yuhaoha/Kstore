			...
			<div class="hero-content pb-5 text-center">
				...
				<div class="row">
					<div class="col-xl-8 offset-xl-2">
						<p class="lead text-muted">Choose the payment method.</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-lg-8">
					<ul class="custom-nav nav nav-pills mb-5">
						<li class="nav-item w-25"><a href="checkout1"
							class="nav-link text-sm ">地址</a></li>
						<li class="nav-item w-25"><a href="checkout2"
							class="nav-link text-sm ">运送方式</a></li>
						<li class="nav-item w-25"><a href="checkout3"
							class="nav-link text-sm active">支付方式 </a></li>
						<li class="nav-item w-25"><a href="order"
							class="nav-link text-sm disabled">订单一览</a></li>
					</ul>
					<div class="mb-5">
						<div id="accordion" role="tablist">
							<div class="block mb-3">
								<div id="headingOne" role="tab" class="block-header">
									<strong><a data-toggle="collapse" href="#collapseOne"
										aria-expanded="true" aria-controls="collapseOne"
										class="accordion-link">Credit Card</a></strong>
								</div>
										...
										<form action="#">
											<div class="row">
												<div class="form-group col-md-6">
													<label for="card-name" class="form-label">信用卡</label> <input type="text" name="card-name"
														placeholder="Name on card" id="card-name"
														class="form-control">
												</div>
												<div class="form-group col-md-6">
													<label for="card-number" class="form-label">卡号</label> <input type="text" name="card-number"
														placeholder="Card number" id="card-number"
														class="form-control">
												</div>
												<div class="form-group col-md-4">
													<label for="expiry-date" class="form-label">到期时间</label> <input type="text" name="expiry-date"
														placeholder="MM/YY" id="expiry-date" class="form-control">
												</div>
												<div class="form-group col-md-4">
													<label for="cvv" class="form-label">CVC/CVV</label> <input
														type="text" name="cvv" placeholder="123" id="cvv"
														class="form-control">
												</div>
												<div class="form-group col-md-4">
													<label for="zip" class="form-label">邮政编码</label> <input
														type="text" name="zip" placeholder="123" id="zip"
														class="form-control">
												</div>
											</div>
										</form>
							...
							<div class="block mb-3">
								<div id="headingTwo" role="tab" class="block-header">
									<strong><a data-toggle="collapse" href="#collapseTwo"
										aria-expanded="false" aria-controls="collapseTwo"
										class="accordion-link collapsed">支付宝</a></strong>
								</div>
								<div id="collapseTwo" role="tabpanel"
									...
									<div class="block-body py-5 d-flex align-items-center">
										...
										<label for="payment-method-1" class="ml-3"><strong
											class="d-block text-uppercase mb-2"> 用支付宝支付</strong><span
											class="text-muted text-sm">支付宝，更省心。 </span></label>
									</div>
								</div>
							</div>
							<div class="block mb-3">
								<div id="headingThree" role="tab" class="block-header">
									<strong><a data-toggle="collapse"
										href="#collapseThree" aria-expanded="false"
										aria-controls="collapseThree" class="accordion-link collapsed">货到付款</a></strong>
								</div>
								<div id="collapseThree" role="tabpanel"
									...
									<div class="block-body py-5 d-flex align-items-center">
										...
										<label for="payment-method-2" class="ml-3"><strong
											class="d-block text-uppercase mb-2"> 货到付款</strong><span
											class="text-muted text-sm">请选择顺丰到付 </span></label>
									</div>
								</div>
							</div>
						</div>
					...
					<div
						...
						<a href="checkout2" class="btn btn-link text-muted"> <i
							class="fa fa-angle-left mr-2"></i>返回
						</a><a href="checkout4" class="btn btn-dark">前往订单一览<i class="fa fa-angle-right ml-2"></i>
						</a>
					</div>
				</div>
				<div class="col-lg-4">
