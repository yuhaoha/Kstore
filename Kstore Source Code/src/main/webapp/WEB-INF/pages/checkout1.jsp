								...
								<div aria-labelledby="cartdetails"
									...
									<div class="d-flex justify-content-between">
										<a href="cart" class="btn btn-link text-dark mr-3">查看购物车 <i
											class="fa-arrow-right fa"></i></a><a href="checkout1"
			...
			<div class="row">
				<div class="col-lg-8">
					<ul class="custom-nav nav nav-pills mb-5">
						<li class="nav-item w-25"><a href="checkout1.html"
							class="nav-link text-sm active">地址</a></li>
						<li class="nav-item w-25"><a href="#"
							class="nav-link text-sm disabled">快递方式</a></li>
						<li class="nav-item w-25"><a href="#"
							class="nav-link text-sm disabled">支付方式</a></li>
						<li class="nav-item w-25"><a href="#"
							class="nav-link text-sm disabled">订单一览</a></li>
					</ul>
					<form action="#">
						<div class="block">
							<!-- Invoice Address-->
							<div class="block-header">
								<h6 class="text-uppercase mb-0">发票地址</h6>
							</div>
							<div class="block-body">
								<div class="row">
									<div class="form-group col-md-6">
										<label for="fullname_invoice" class="form-label">姓名</label> <input type="text" name="fullname_invoice"
											placeholder="请输入你的名字" id="fullname_invoice"
											class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="emailaddress_invoice" class="form-label">Email
											Address</label> <input type="text" name="emailaddress_invoice"
											placeholder="请输入你的邮箱" id="emailaddress_invoice"
											class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="street_invoice" class="form-label">街道</label>
										<input type="text" name="street_invoice"
											placeholder="请输入你的地址" id="street_invoice"
											class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="city_invoice" class="form-label">省</label> <input
											type="text" name="city_invoice" placeholder="请输入你的省份"
											id="city_invoice" class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="zip_invoice" class="form-label">邮政编码</label> <input
											type="text" name="zip_invoice" placeholder="请输入你的邮政编码"
											id="zip_invoice" class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="state_invoice" class="form-label">市</label> <input
											type="text" name="state_invoice" placeholder="请输入你的城市"
											id="state_invoice" class="form-control">
									</div>
									<div class="form-group col-md-6">
										<label for="phonenumber_invoice" class="form-label">手机
											</label> <input type="text" name="phonenumber_invoice"
											placeholder="请输入你的手机号" id="phonenumber_invoice"
											class="form-control">
									</div>
									<div class="form-group col-12 mt-3">
										<div class="custom-control custom-checkbox">
											<input id="show-shipping-address" type="checkbox"
												name="clothes-brand" class="custom-control-input"> <label
												for="show-shipping-address" data-toggle="collapse"
												data-target="#shippingAddress" aria-expanded="false"
												aria-controls="shippingAddress"
												class="custom-control-label align-middle">用不同的发货地址</label>
										</div>
									</div>
								</div>
								<!-- /Invoice Address-->
							...
							<div id="shippingAddress" aria-expanded="false" class="collapse">
								<div class="block">
									<div class="block-header">
										<h6 class="text-uppercase mb-0">发货地址</h6>
									</div>
									<div class="block-body">
										<div class="row">
											<div class="form-group col-md-6">
												<label for="street_shipping" class="form-label">街道</label>
												<input type="text" name="street_shipping"
													placeholder="请输入你的街道" id="street_shipping"
													class="form-control">
											</div>
											<div class="form-group col-md-6">
												<label for="city_shipping" class="form-label">市</label> <input
													type="text" name="city_shipping" placeholder="请输入你的城市"
													id="city_shipping" class="form-control">
											</div>
											<div class="form-group col-md-6">
												<label for="zip_shipping" class="form-label">邮政编码</label> <input
													type="text" name="zip_shipping" placeholder="请输入你的邮政编码"
													id="zip_shipping" class="form-control">
											</div>
											<div class="form-group col-md-6">
												<label for="state_shipping" class="form-label">省</label>
												<input type="text" name="state_shipping" placeholder="请输入你的省份"
													id="state_shipping" class="form-control">
											</div>
											<div class="form-group col-md-6">
												<label for="phonenumber_shipping" class="form-label">手机</label> <input type="text" name="phonenumber_shipping"
													placeholder="请输入你的手机号" id="phonenumber_shipping"
													class="form-control">
											</div>
										</div>
									</div>
						...
						<div
							...
							<a href="cart" class="btn btn-link text-muted"> <i
								class="fa fa-angle-left mr-2"></i>返回
							</a><a href="checkout2" class="btn btn-dark">选择运送方式<i class="fa fa-angle-right ml-2"></i>
							</a>
						</div>
					</form>
				</div>
				<div class="col-lg-4">
					<div class="block mb-5">
						<div class="block-header">
							<h6 class="text-uppercase mb-0">订单统计</h6>
						</div>
						<div class="block-body bg-light pt-1">
							<p class="text-sm">购物总额计算在下面</p>
							<ul class="order-summary mb-0 list-unstyled">
								<li class="order-summary-item"><span>订单总额
								</span><span>${cartbartotal} RMB</span></li>
								<li class="order-summary-item"><span>运费</span><span>0.00 RMB</span></li>
								<li class="order-summary-item"><span>邮费</span><span>0.00
										RMB</span></li>
								<li class="order-summary-item border-0"><span>总计</span><strong
									class="order-summary-total">${cartbartotal} RMB</strong></li>
							</ul>
						</div>
					</div>
				</div>
